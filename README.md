...
I tested with 20 workers and gpt-4.1-mini, took less than 3 minutes to score over 700 papers and costed about $0.3.
...
- Turn it into a pure frontend app that doesn't require the CLI.
- Add support for self-hosted LLMs.